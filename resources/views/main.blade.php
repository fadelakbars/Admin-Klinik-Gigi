                ...
                <div class="container-fluid">
					...
					<div class="navbar-nav align-items-end mr-3  mt-2">
						<div class="profile-pic align-items-center d-flex" href="#" aria-expanded="false"> 
							<img src="{{ asset('style/assets/img/profile.jpg') }}" alt="user-img" width="36" class="img-circle"><h6 style="margin-left: 15px; margin-right: 20px; margin-top: 10px;">FIFIN DENTAL KLINIK</h6> 
						</div>
						<div class="">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <nav class="pull-left">
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="nav-link" href="https://api.whatsapp.com/send?phone=6282172151933" target="blank">
                    ...
                    <div class="copyright ml-auto">
                        2024, made with <i class="la la-connectdevelop la-1X text-black"></i> by <a href="https://www.instagram.com/fadelakbars_/" target="blank">fdelna</a>
                    </div>				
                </div>
            </footer>
        </div>
